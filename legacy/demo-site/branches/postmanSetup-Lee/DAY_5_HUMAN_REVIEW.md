...
| **Orange** | Elevated context | REVIEW_CAREFULLY | ❌ Never |
| **Red** | Significant context | REVIEW_CAREFULLY | ❌ Never |
...
1. **[humanReviewRules.js](../src/backend/etas/humanReviewRules.js)** — Complete human review framework:
