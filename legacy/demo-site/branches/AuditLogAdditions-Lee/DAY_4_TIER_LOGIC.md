...
Updated [tripValidation.js](../src/backend/etas/tripValidation.js) to:
...
1. **[tierDefinitions.js](../src/backend/etas/tierDefinitions.js)** — Enhanced with:
...
2. **[tripValidation.js](../src/backend/etas/tripValidation.js)** — Updated to:
