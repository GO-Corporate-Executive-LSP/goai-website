...
- Payment logs: 
  ...
  - Retry strategy: SHORT_BACKOFF (30s)
  - Attempt 2: Success (transaction ID)
- Failure logs: PAYMENT_FAILURE recorded, then resolved
...
2. **[tierDefinitions.js](../src/backend/etas/tierDefinitions.js)** — Tier capacity rules (Day 4)
3. **[humanReviewRules.js](../src/backend/etas/humanReviewRules.js)** — Review triggers (Day 5)
4. **[rolesPermissions.js](../src/backend/etas/rolesPermissions.js)** — Permission system (Day 6)
5. **[failureHandling.js](../src/backend/etas/failureHandling.js)** — Retry logic (Day 7)
